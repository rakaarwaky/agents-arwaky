#!/usr/bin/env python3
"""Installer vision — vision-arwaky (Python, uv): full name + alias va."""
...
LAUNCHERS = [('vision-arwaky', 'vision-arwaky'), ('vision-arwaky-cli', 'vision-arwaky'), ('va', 'vision-arwaky'), ('vision-arwaky-mcp', 'vision-arwaky-mcp')]
...
def _uv_launcher(entry: str) -> str:
    ...
    return (
        ...
        f'os.execvpe("uv", ["uv", "run", "--directory", str(root / "internal/vision-arwaky"), '
