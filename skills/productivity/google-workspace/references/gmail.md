...
**Search syntax**: The `query` parameter uses standard Gmail search syntax (`from:`, `to:`, `subject:`, `is:unread`, `has:attachment`, `newer_than:7d`, `label:`, `category:`, `rfc822msgid:`). The full operator table and worked patterns are in [gmail-search-syntax.md](gmail-search-syntax.md).
