...
class TestTextHelpers:
    def test_blank_fenced_preserves_line_numbers(self):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import blank_fenced
        text = "head\n\n```md\nStatus: inside\n```\n\nafter\n"
    ...
    def test_parse_tables_reports_line_numbers(self):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import parse_tables
    ...
    def test_find_section_tolerates_decorated_headings(self):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import find_section
...
class TestSpecStatusBoundary:
    def test_clean_project_has_no_errors(self, project):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import audit_docs, errors_only
...
class TestBacklogHonesty:
    ...
    def test_scenario_count_drift_is_a_warning(self, project):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import audit_docs, warnings_only
        spec = project / "modules" / "alpha" / "FRD.md"
...
class TestSeverities:
    ...
    def test_as_strict_promotes_warnings(self, project):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import as_strict, audit_docs, errors_only, warnings_only
        (project / "AGENTS.md").write_text("# demo\n\n## Commands\n\n`pytest -q`\n")
        findings = audit_docs(project)
    ...
    def test_submodule_trees_are_skipped_by_default(self, project):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import audit_docs, errors_only, iter_doc_files
    ...
    def test_tool_cache_dirs_are_skipped(self, project):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import audit_docs, iter_doc_files
...
class TestGuideMatchesTheGate:
    ...
    def _same(a: str, b: str) -> bool:
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import _norm
    ...
    def test_required_rows_equal_the_gate(self, doc, ref):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import REQUIRED_SECTIONS
    ...
    def test_backlog_reference_carries_every_gated_section(self):
        from modules.shared.src.common.doc_pack.capabilities_doc_pack import MASTER_ONLY_SECTIONS, REQUIRED_SECTIONS
