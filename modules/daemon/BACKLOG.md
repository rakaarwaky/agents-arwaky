...
|----|---------|-----------|:---------|-------|------------------|-------|--------------|---------|
| DMN-01 | FR-DAEMON-001, FR-DAEMON-002 | Daemon lifecycle + auth-key | P1 | QA | 2 capabilities + contract at `5556fd5`; import OK. Live Podman sweep outstanding (needs host + WS-05). | @raka | WS-05 | 2026-09-18 |
| DMN-02 | FR-DAEMON-001 | Deploy assets (systemd units, Containerfile) | P1 | Done | `modules/daemon/deploy/` ships `anytype-daemon.service`, `omniroute.service`, `Containerfile` at `5556fd5`. | @raka | None | 2026-09-18 |
| DMN-03 | FR-DAEMON-001, FR-DAEMON-002 | FRD + BACKLOG pair authoring for daemon | P1 | In Progress | Files written in this sweep. | @raka | None | 2026-09-18 |
