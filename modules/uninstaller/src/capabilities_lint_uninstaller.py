"""lint-arwaky uninstaller — strict verbatim port of tools/uninstall/uninstall_lint.py.
...
class LintUninstaller(IToolUninstaller):
    ...
    def uninstall(self, spec: ToolSpec) -> UninstallResult:
        rc = _uninstall()
        return UninstallResult(rc == 0, spec.id, "lint-arwaky uninstalled (launchers + data + config + cache)")
