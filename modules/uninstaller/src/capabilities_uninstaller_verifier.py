"""FR-002: confirm the owned set is gone and produce the removal report.

Runs only after FR-001 completes (success OR partial) — a failed removal still
...
from modules.uninstaller.src.capabilities_uninstaller_remover import (
    _DAEMON_UNIT_TOOLS,
    _LAUNCHERS,
)
from modules.uninstaller.src.contract_tool_uninstaller_protocol import IToolVerifier
...
class UninstallerVerifier(IToolVerifier):
    """Confirm owned-set removal and report named residuals (FR-002)."""
