"""AnytypeRunner — per-tool runner capability (delegates discovery/execution to RunnerBase)."""
...
class AnytypeRunner(RunnerBase, IToolExecutor):
    """Per-tool runner capability for anytype; inherits RunnerBase behaviour."""
