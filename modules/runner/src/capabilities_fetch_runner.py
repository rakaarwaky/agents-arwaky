"""FetchRunner — per-tool runner capability (delegates discovery/execution to RunnerBase)."""
...
class FetchRunner(RunnerBase, IToolExecutor):
    """Per-tool runner capability for fetch; inherits RunnerBase behaviour."""
