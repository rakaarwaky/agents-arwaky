"""FR-001 capability — discover a tool's executable path (runner feature).
...
from modules.runner.src.contract_tool_runner_protocol import IToolDiscoverer

#: Sentinel launch marker: internal tools whose launcher is a runner script.
_INTERNAL_RUNNERS = ("cargo", "uv", "python")


class RunnerDiscoverer(IToolDiscoverer):
