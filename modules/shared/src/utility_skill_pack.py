...
Pure audit primitives (iter_skill_files, audit_pack, PackFinding) live in the
shared taxonomy layer (:mod:`modules.shared.src.taxonomy_common_vo`). This
module keeps only the I/O-bound write_provenance / prune_provisioned helpers.
"""
