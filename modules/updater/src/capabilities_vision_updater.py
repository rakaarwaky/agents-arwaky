"""Vision updater (uv venv, force) — port of tools/update/update_vision.py.

Always pulls internal/vision-arwaky, then force-recreates the venv,
pip-reinstalls the package, and rewrites the launcher symlinks.
"""
...
class VisionUpdater(IToolUpdater):
    """Force-reinstall internal/vision-arwaky in a uv venv (XDG compliant)."""
