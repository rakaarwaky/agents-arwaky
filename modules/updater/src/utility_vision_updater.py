"""Vision updater adapter — leaf utility for one manifest tool.

Mirrors the original tools/update/update_vision.py mechanics: submodule
...
class VisionUpdaterAdapter:
    """Vision (venv/pip) update sequence."""
