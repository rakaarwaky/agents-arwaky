...
runner): one `ToolsOrchestrator` agent, four action capability classes
(install/update/uninstall/run, each multi-method), thirteen unified per-tool adapters (one per manifest tool
