"""FR-004 capability — record the version transition.

Runs only after a successful FR-003 bump. Writes a human-readable
transition record under the tool's XDG state dir. Idempotent:
