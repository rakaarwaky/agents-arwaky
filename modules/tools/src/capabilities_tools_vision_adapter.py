...
Implements `IToolsProtocol` (AES403) and exports the `vision`
...
class VisionToolsAdapter(IToolsProtocol):
    """Vision actions behind the tools protocol (AES403 implementor)."""
    ...
    def execute(
        ...
        """Dispatch *op* against this file's vision unit."""
        return dispatch_unit_op(self._units, op, spec, query, args, label="vision adapter")
