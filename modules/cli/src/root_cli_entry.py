...
The only differences are the import swaps to the AES modules:
  - manifest        -> modules.shared.src.manifest.* (Tool, load_tools, find_tool)
  ...
  - doc_pack        -> modules.shared.src.doc_pack.capabilities_doc_pack
...
def cmd_docs(argv: list[str]) -> int:
    ...
    from modules.shared.src.doc_pack.capabilities_doc_pack import as_strict, audit_docs, errors_only, iter_doc_files, warnings_only
